...
The PWM signal generated by the BigQuad deck is characterized by 
* Frequency: 400 Hz
* Voltage: Vbase = 1.2V, PkPk = 5.0V


To change the PkPk voltage, the following resistor step-down circuit is implemented:

<img src="https://github.com/Gloogger/Crazyflie-BigQuad-Prototype/blob/main/images/ESC_resistor.png" width="600">

**However**, later I came to know that there is a better, off-the-shelf solution, which is to use the logic level converter circuit. For some time, I have replaced the resistor step-down circuit with the SparkFun Logic Level Converter - Bi-Directional (3.3V - 5V):

<img src="https://github.com/Gloogger/Crazyflie-BigQuad-Prototype/blob/main/images/SparkFun_logic_converter.jpeg" width="300">


How to change system parameters in python code? See \href{https://forum.bitcraze.io/viewtopic.php?t=5089}{this discussion thread}.

\subsection{ESC Calibration}
Calibrate the ESCs using a transmitter and a receiver with respect to a 5V signal could solve the non-uniform 0\% throttle datum issue. 
