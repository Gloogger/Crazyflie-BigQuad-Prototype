...
To solve the inconsistent 0% throttle datum issue, I simply defined a throttle mapping function and then use the `motorPowerSet` API to send the individual PWM signal to each ESC:
